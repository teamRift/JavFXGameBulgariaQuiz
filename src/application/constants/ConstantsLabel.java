...
public class ConstantsLabel {

    public static final String LABEL_DIFFICULTY = "Choose difficult";
    ...
    public static final String LABEL_PLAYINGINSTRUCTIONS_BTN = "How to play";

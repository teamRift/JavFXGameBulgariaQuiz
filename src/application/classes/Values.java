...
public class Values
{
    ...
    public static final String QUESTIONS_SF = "sofiaQuestions.txt";
    public static final String QUESTIONS_BS = "burgasQuestions.txt";
    public static final String QUESTIONS_BLG = "blagoevgradQuestions.txt";
    public static final String QUESTIONS_RS = "ruseQuestions.txt";
    public static final String QUESTIONS_VN = "varnaQuestions.txt";
    public static final String QUESTIONS_PLD = "plovdivQuestions.txt";
    public static final String QUESTIONS_PLN = "plevenQuestions.txt";
    public static final String QUESTIONS_VT = "velikoturnovoQuestions.txt";
    public static final String QUESTIONS_MOCK = "mordorQuestions.txt";
